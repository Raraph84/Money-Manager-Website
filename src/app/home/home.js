    ...
    render() {
        ...
        return <div className="home-page">
            ...
            {this.state.people && <div className="people-accounts">
                ...
                <div className="list">{this.state.people.slice(1).filter((person) => person.balance).sort((a, b) => b.balance - a.balance).map((person) => <Link key={person.id} href={"/people/" + person.id}>
            ...
            {this.state.accounts && <div className="people-accounts">
                ...
                <div className="list">{this.state.accounts.filter((account) => account.balance).sort((a, b) => b.balance - a.balance).map((account) => <Link key={account.id} href={"/accounts/" + account.id}>
